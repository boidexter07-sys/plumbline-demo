...
const CONVICTIONS = [
  { title: "Observation, not recommendation.", desc: "Pulse is a read on conditions. It does not tell you to buy, sell, trim, or add. The bands describe how much is happening \u2014 not whether the happening is good or bad. The 29-factor model was rebuilt around this conviction, not the other way around." },
  { title: "Free data, public methods.", desc: "Every source Pulse reads is free and public \u2014 Yahoo, Statistics Canada, FRED, GDELT, Polymarket, Kalshi, PredictIt. The full factor table, weights, and equations live on the Model Details page. Nothing is hidden behind a settings toggle. Nothing is proprietary." },
